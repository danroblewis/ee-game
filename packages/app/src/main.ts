...
function frame(now: number) {
  ...
  hud.textContent =
    ...
    (mode ? `   ${mode}` : '') +
    `\nparts: R C L W G V D N P M A U 5 S B T Z E F I · Q rotate · drag pin = wire · drag empty = select · ⌘C/⌘V copy/paste · 1/2 probe · 3 listen · 0 ref · O scope · X delete · / search`;
